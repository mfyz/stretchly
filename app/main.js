...
function startMicrobreak () {
	...
	for (let displayIdx = 0; displayIdx < numberOfDisplays(); displayIdx++) {
		...
		microbreakWinLocal.once('ready-to-show', () => {
			...
			microbreakWinLocal.webContents.executeJavaScript("document.getElementById('bgColor').style.backgroundColor='" + settings.get('mainColor') + "'")
		})
...
function startBreak () {
	...
	for (let displayIdx = 0; displayIdx < numberOfDisplays(); displayIdx++) {
		...
		breakWinLocal.once('ready-to-show', () => {
			...
			breakWinLocal.webContents.executeJavaScript("document.getElementById('bgColor').style.backgroundColor='" + settings.get('mainColor') + "'")
		})
